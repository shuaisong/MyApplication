...
public class PreferenceManager {
    ...
    public void saveSearchKey(SearchType.DataObjBean bean, String searchType) {
        Gson mGson = new Gson();
        String mToJson = mGson.toJson(bean);
        editor.putString("SearchType" + searchType, mToJson).apply();
    }

    public SearchType.DataObjBean getSearchKey(String type) {
        SearchType.DataObjBean bean = new SearchType.DataObjBean();
        String beans = mMSharedPreferences.getString("SearchType" + type, null);
        if (beans == null) {
            return bean;
        }
        Gson mGson = new Gson();
        bean = mGson.fromJson(beans, new TypeToken<SearchType.DataObjBean>() {
        }.getType());
        return bean;
    }
   ...
   /* public <T> List<T> getRecommendLabelList() {
    ...
    public  RecommendLabel.DataObjBean getRecommendLabelList(){
        String mRecommendLabel = mMSharedPreferences.getString("RecommendLabel", null);
        Gson mGson = new Gson();
        return mGson.fromJson(mRecommendLabel, new TypeToken<RecommendLabel.DataObjBean>() {
        }.getType());
    }
    public void saveRecommend(RecommendLabel.DataObjBean bean) {
        Gson mGson = new Gson();
        String mToJson = mGson.toJson(bean);
        editor.putString("RecommendLabel", mToJson).apply();
    ...
    public boolean getLogin() {
        return mMSharedPreferences.getBoolean("logIn",false);
    }
}
