...
public class CheckNet {
    ...
    public boolean isNetworkConnected() {
        ConnectivityManager mSystemService = (ConnectivityManager) App.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean isWifiProxy() {
        ...
        if (is_ics_or_later) {
            ...
            proxyAddress = android.net.Proxy.getHost(App.getInstance());
            proxyPort = android.net.Proxy.getPort(App.getInstance());
